...
public class Selection extends JFrame
{
	...
	f.setLayout(null); 
	 ...
	 JPanel panel=new JPanel();  
		...
		ImageIcon gifIcon = new ImageIcon("H:\\Java Project\\Image\\international.png");
		...
		ImageIcon gifIcon1 = new ImageIcon("H:\\Java Project\\Image\\international.png");
    ...
    ImageIcon gifIcon2 = new ImageIcon("H:\\Java Project\\Image\\national.jpg");
		...
		ImageIcon gifIcon3 = new ImageIcon("H:\\Java Project\\Image\\national.jpg");
...
plane2.addMouseListener(new MouseListener(){
    ...
    travel.addMouseListener(new MouseListener(){
	    ...
	    JLabel heading = label("Select Your Flight Type",450,150,400,40);
