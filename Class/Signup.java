...
"Qutar","Romania","Russia","Rwanda","Saudi Arabia","Senegal","Serbia","Seychelles","Sierra Leone","Singapore","South Africa","South Sudan","Spain","SriLanka","Sudan","Suriname","Sweden","Switzerland",
    ...
    male.setBounds(185, 290,60,30);
	male.setBackground(new Color(124, 180, 107));
    ...
    female.setBounds(250,290,80,30);
	female.setBackground(new Color(124, 180, 107));
    ...
    g.setBackground(new Color(124, 180, 107));
   ...
   co.setForeground(Color.black);
    //countr.setForeground(new Color(0x292929));
    //countr.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0,new Color(0,0,0)));
	login.add(co);
  ...
  openImg1.addMouseListener(new MouseAdapter(){
	...
	term.setBackground(new Color(124, 180, 107));
    ...
    b.setToolTipText("Please Sign Up");}  
	 ...
	 JLabel name12 = new JLabel("Front-end -- FAHAD  ||  Back-end -- RIYADH");
...
//boolean bln2 = female.isSelected();
			 ...
			 try{
                 ...
                 s1 = value.getText();   //pas1
				 s2 = value1.getText(); //pas2
				 s3 = text.getText();
				 s4 = t.getText();
				 s5 = t2.getText();
				 s6 = p.getText();
				...
				boolean check = file.exists();
				 ...
				 if(s1.isEmpty()||s2.isEmpty()||s3.isEmpty()||s4.isEmpty()||s5.isEmpty()||s6.isEmpty()||s7==null||s8==null||s9==null||s10==null||s13==null)
				 {
					...
					if(check != true){
						...
						if(s1.equals(s2) ){
							FileWriter fw = new FileWriter(s11,true);
