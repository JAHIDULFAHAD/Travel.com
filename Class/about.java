...
public class about{
	...
	team0.setFont(font2);
	heading.add(team0);
	JLabel team01 = new JLabel("the world. An easier way to book flights, bus tickets,");
	team01.setBounds(230,100,500,40);
	team01.setFont(font2);
	heading.add(team01);
	JLabel team012 = new JLabel(" and hotels will hopefully fulfill your demands as we ");
	team012.setBounds(230,120,500,40);
	team012.setFont(font2);
	heading.add(team012);
	JLabel team0123 = new JLabel(" have gathered everything into a single package.");
    ...
    panel51.setBounds(300,45,160,2);    
    panel51.setBackground(new Color(171,214,223)); 
    login.add(panel51);*/
	
	JLabel team1 = new JLabel("Jahidul Haque Fahad");
	...
	JLabel team12 = new JLabel("Md. Riyadh Ullah");
	...
	JLabel team123 = new JLabel("Minhajun Nabi Shiam");
